...
export class ArticleService {
  ...
  public getArticlesByAuthorId(authorId: string) {
    ...
    return this.httpClient.get<ResponseModel>(Constants.BASE_URL + "Article/GetAllArticle", { headers: headers }).pipe(map(res => {
  ...
  public getPublishedArticles(authorId: string) {
    ...
    return this.httpClient.get<ResponseModel>(Constants.BASE_URL + "Article/GetArticleByAuthorId?AuthorId=" + authorId, { headers: headers }).pipe(map(res => {
      let articleList = new Array<Article>();
      if (res.responseCode == ResponseCode.OK) {
